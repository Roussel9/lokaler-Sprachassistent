"""
Text-to-Speech mit Piper — deutsche Männerstimme (Thorsten), offline.
"""
...
# Feste Stimme — kein Zufallsrauschen
...
class Synthesizer:
    """Wandelt Text in Sprache um — immer dieselbe männliche Stimme."""
    ...
    def synthesiere(self, text: str, dateiname: str = None) -> tuple:
        text = bereite_text_fuer_tts(text)
        print(f"Synthesiere: '{text[:60]}...' " if len(text) > 60 else f"Synthesiere: '{text}'")
        ...
        print(f"OK WAV gespeichert: {wav_pfad}")
